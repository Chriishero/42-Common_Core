...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2025/11/27 07:05:42 by cvillene          #+#    #+#              #
#    Updated: 2025/11/27 07:55:32 by cvillene         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
class Tree(Plant):
	...
	def produce_shade(self):
		print(f"{self.name} provides {((self.age * self.trunk_diameter) / self.height**2 * 200):.0f} square meters of shade\n")
